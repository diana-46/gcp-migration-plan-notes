...
> 관련: [[10-스케줄러/9_Airflow Asset과 Dataset]], [[10-스케줄러/10_DataHub vs Knowledge Catalog 비교]], [[20-애슬론/4_Asset-Centric 아키텍처 안]]
...
- **로컬에서 수동 emit** — 데이터플랫폼팀 담당 (관련: [[20-애슬론/8_배포 시 유의할 점]] § 4)
...
상세: [[10-스케줄러/10_DataHub vs Knowledge Catalog 비교]]
...
- [[10-스케줄러/10_DataHub vs Knowledge Catalog 비교]] — 툴 선정 근거
- [[20-애슬론/4_Asset-Centric 아키텍처 안]] — Asset 중심 아키텍처 설계
- [[20-애슬론/8_배포 시 유의할 점]] § 4-5 — DataHub CI 제약 실전
- [[21-dbt/2_schema 관리]] — schema.yml 을 통한 문서화 흐름
