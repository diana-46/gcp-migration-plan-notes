...
> 두 결정을 뒷받침하는 조사 결과. 각 주제는 이미 별도 노트 (`[[platform/airflow/*]]`) 에서 상세 다룸.
...
- 상세: [[platform/airflow/asset/11_Airflow Asset과 Dataset]]
...
상세: [[8_실행계획과_안전장치]], [[platform/athlon/6_마이그레이션 플랜]]

## 관련 문서

- [[platform/airflow/0_결론]] — 최종 결론
- [[platform/airflow/1_개요]] — 전체 방향
- [[platform/airflow/README]] — 스케줄러 폴더 인덱스
