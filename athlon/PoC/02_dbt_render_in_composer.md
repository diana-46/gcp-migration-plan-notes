...
> 실제 실행 시도 시엔 [[../../scheduler/PoC/03_custom_operator_pypi]] 의 AR 패턴으로 wheel push.
...
Composer 3 가 dbt + Cosmos 의 일반적 stack 다 받아줌. 사내 fork (`custom-dbt-trino`) 가 필요한 경우엔 [[../../scheduler/PoC/03_custom_operator_pypi]] 의 AR 패턴 적용 가능.
...
- [[../../scheduler/PoC/04_worker_pool_queue]] — Composer 의 worker / queue / pool 검증
