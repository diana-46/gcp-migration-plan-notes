...
>
> 관련: [[10-스케줄러/15_관리 레포 인벤토리]], [[10-스케줄러/14_Composer 3 비용 구조]]
...
**핵심**: 팀별 저장소 = **팀 자율성 + 비용·리소스 최적화 실행 수단** (관련: [[10-스케줄러/0_결론]] 의 Phase 1/2 비용 절감 목표).
...
- Floor cost × 팀 수 발생 (팀당 ~$200-300/월, 관련: [[10-스케줄러/14_Composer 3 비용 구조]])
...
**"공용 helper / 상수는 어디에"**
- `apache-airflow-providers-kakaoent-dataplatform` 패키지에 (관련: [[10-스케줄러/7_3_공통 Custom Operator 제공 방안]])
- 팀 저장소는 얇게 유지
...
- [[10-스케줄러/15_관리 레포 인벤토리]] — 3-layer 저장소 구조 + athlon DB 한계
- [[10-스케줄러/14_Composer 3 비용 구조]] — DCU 요금 모델
- [[10-스케줄러/7_1_실제 스펙 산정]] — 리소스 실측
- [[10-스케줄러/7_2_리소스 다이어트 포인트]] — 다이어트 축들
- [[10-스케줄러/11_DAG Bundles와 배포 전략]] — 배포 전략
