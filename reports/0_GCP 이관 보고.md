...
상세: [[athlon/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]]
...
- ETL 인벤토리 + 우선순위 매기기
- DE 온보딩 워크샵
- 자세한 활동: [[athlon/6_마이그레이션 플랜]] § 4

### 5-3. Phase 1 ~ Phase 3 (8~9개월)

[[athlon/6_마이그레이션 플랜]] 참조.
...
| 노트 | 내용 |
|---|---|
| [[athlon/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]] | PoC 결론 — 기술 실현 가능성 확정 |
| [[athlon/6_마이그레이션 플랜]] | Phase 별 활동 / RACI / Gate / 일정 |
| [[scheduler/15_관리 레포 인벤토리]] | 운영 모델 (3 레포) / AS-IS vs TO-BE |
| [[dbt/1_materialization]] ~ [[dbt/6_배포와 환경 분리]] | dbt 패턴 상세 |
| [[athlon/2_Git 동기화·dbt 전환 계획]] | 초기 전환 계획 |
| [[athlon/3_dbt 능력 경계와 영역 분담]] | dbt vs Airflow 책임 분리 |
| [[athlon/4_Asset-Centric 아키텍처 안]] | Asset 기반 아키텍처 |
