...
> 관련: [[platform/airflow/asset/11_Airflow Asset과 Dataset]], [[platform/airflow/_archive/10_DataHub vs Knowledge Catalog 비교]], [[platform/athlon/4_Asset-Centric 아키텍처 안]]
...
- **로컬에서 수동 emit** — 데이터플랫폼팀 담당 (관련: [[platform/athlon/8_배포 시 유의할 점]] § 4)
...
상세: [[platform/airflow/_archive/10_DataHub vs Knowledge Catalog 비교]]
