...
- **단순 "dbt가 좋은가" 같은 일반론**은 여기 안 적음. [[../scheduler/README]] 또는 별도 dbt 폴더 (필요 시) 영역.
...
- **Airflow 외 스케줄러** → [[../scheduler/README]] 영역 (Airflow 유지 확정)
...
| 어디서? | 다루는 내용 |
|---|---|
| [[../scheduler/README\|스케줄러/]] | Airflow 인프라(Composer vs Self-managed), **Airflow에서 dbt를 어떻게 실행** (Operator 선택 / Pod 스펙 / manifest 전달) |
