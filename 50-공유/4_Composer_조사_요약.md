...
> 두 결정을 뒷받침하는 조사 결과. 각 주제는 이미 별도 노트 (`[[10-스케줄러/*]]`) 에서 상세 다룸.
...
- 상세: [[10-스케줄러/2_Cloud Composer vs Self-managed 비교]]
...
- 상세: [[10-스케줄러/6_Airflow 2 vs 3 비교]]
...
- 상세: [[10-스케줄러/3_Executor 종류 및 비교]], [[10-스케줄러/4_Queue 라우팅과 Pod 스펙 설정]]
...
- 상세: [[10-스케줄러/14_Composer 3 비용 구조]], [[10-스케줄러/7_0_Composer 비용 한눈에]]
...
- 상세: [[10-스케줄러/7_1_실제 스펙 산정]], [[10-스케줄러/7_2_리소스 다이어트 포인트]]
...
- 상세: [[10-스케줄러/9_Airflow Asset과 Dataset]]
...
- 상세: [[10-스케줄러/11_DAG Bundles와 배포 전략]]
...
- 상세: [[10-스케줄러/5_Metadata DB 운영]], [[10-스케줄러/13_Composer 3 환경 업그레이드 정책]]
...
- 상세: [[10-스케줄러/7_3_공통 Custom Operator 제공 방안]], [[10-스케줄러/7_4_DAG + dbt + Operator 3축 배포 통합]]
...
상세: [[8_실행계획과_안전장치]], [[20-애슬론/6_마이그레이션 플랜]]

## 관련 문서

- [[10-스케줄러/0_결론]] — 최종 결론
- [[10-스케줄러/1_개요]] — 전체 방향
- [[10-스케줄러/README]] — 스케줄러 폴더 인덱스
