...
> 관련: [[scheduler/7_4_DAG + dbt + Operator 3축 배포 통합]], [[scheduler/15_관리 레포 인벤토리]]
...
**표준 순서** (관련: [[athlon/8_배포 시 유의할 점]] § 1):
...
- [[scheduler/7_3_공통 Custom Operator 제공 방안]] — Provider 패키지 상세
- [[scheduler/7_4_DAG + dbt + Operator 3축 배포 통합]] — 3-layer 통합 배포
- [[scheduler/15_관리 레포 인벤토리]] — 저장소 인벤토리 + athlon → git 전환
- [[scheduler/11_DAG Bundles와 배포 전략]] — DAG 배포 세부
- [[athlon/8_배포 시 유의할 점]] — 실전 배포 순서 함정
