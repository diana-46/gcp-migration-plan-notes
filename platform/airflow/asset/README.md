...
기존 [[platform/airflow/asset/11_Airflow Asset과 Dataset]] 문서가 개념/기능 소개를 다뤘다면, 이 디렉토리는 **"실제로 붙여보니 어떻게 동작하고, 뭐가 안 되고, 3.2/3.3 이 어떻게 바뀌는가"** 를 다룬다.
...
- [[platform/airflow/asset/11_Airflow Asset과 Dataset]] — Asset/Dataset 개념 소개 (선행 자료)
- [[docs/shared/10_Sensor를_Triggerer와_Asset으로_대체하기]] — 초기 sensor 대체 논의
- [[docs/shared/11_Cosmos란]] — Cosmos 개념
