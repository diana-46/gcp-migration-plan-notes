...
| 동시성 제어 | Airflow Pool (`dbt_small`, 3 slots) | 동일 (Composer Pool 동작 확인됨 — [[../../scheduler/PoC/04_worker_pool_queue]]) |
...
| DataHub lineage | [[athlon/PoC/README]] Step 4 별도 PoC |
...
- [[../../scheduler/PoC/02_dag_deployment]] — Composer DAG 배포 흐름
- [[../../scheduler/PoC/03_custom_operator_pypi]] — 사내 wheel install 패턴 (BQ 운영 시 사내 macro 모듈 재사용 시 활용 가능)
- [[../../scheduler/PoC/04_worker_pool_queue]] — Pool 동작 검증
