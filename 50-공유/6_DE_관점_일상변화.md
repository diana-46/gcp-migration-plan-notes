...
1. **dbt 기초**
   ...
   - 학습 자료: [[21-dbt/0_dbt 기본 개념]] ~ [[21-dbt/7_테이블 아웃풋]]
...
- **마이그레이션 시간은 OKR 로 인정** ([[20-애슬론/6_마이그레이션 플랜]] § 9)
...
2. 파티션 / 세만틱 mapping (관련: [[21-dbt/1_materialization]], [[21-dbt/7_테이블 아웃풋]])
...
- [[21-dbt/0_dbt 기본 개념]] — dbt 기본기 (1-2시간 리딩)
- [[21-dbt/1_materialization]] ~ [[21-dbt/8_insert_overwrite_매커니즘]] — 응용 상세
- [[20-애슬론/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]] — 이관 검증
- [[20-애슬론/8_배포 시 유의할 점]] — 실전 함정
