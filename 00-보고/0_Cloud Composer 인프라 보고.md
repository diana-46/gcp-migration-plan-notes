...
| 노트 | 인프라 관점에서의 가치 |
|---|---|
| [[20-애슬론/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]] | PoC 결론 + 기술 실현성 |
| [[20-애슬론/6_마이그레이션 플랜]] | Phase 별 일정 / 리소스 |
| [[10-스케줄러/15_관리 레포 인벤토리]] | 운영 모델 / 레포 구조 |
| [[21-dbt/6_배포와 환경 분리]] | 배포 자동화 / 실측 함정 5가지 |
