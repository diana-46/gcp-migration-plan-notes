...
> 관련: [[10-스케줄러/6_Airflow 2 vs 3 비교]], [[10-스케줄러/1_개요]], [[20-애슬론/8_배포 시 유의할 점]]
...
관련: [[10-스케줄러/2_Cloud Composer vs Self-managed 비교]], [[10-스케줄러/0_결론]]
...
- 관련: [[10-스케줄러/7_3_공통 Custom Operator 제공 방안]]
...
- 실측 예 ([[10-스케줄러/7_2_리소스 다이어트 포인트]]): sensor 하나가 **월 522 worker-hours**
...
- 관련: [[20-애슬론/8_배포 시 유의할 점]] § 2

### 2-6. 인증 · 권한

**3-layer 모델** (관련: [[10-스케줄러/8_Composer 권한 및 인증]]):
...
- 관련: [[10-스케줄러/14_Composer 3 비용 구조]], [[4_Composer_조사_요약]] § 4
...
- [[10-스케줄러/6_Airflow 2 vs 3 비교]] — Airflow 버전 breaking change 상세
- [[10-스케줄러/1_개요]] — Composer 3 운영 방향
- [[10-스케줄러/2_Cloud Composer vs Self-managed 비교]] — Composer 채택 근거
- [[10-스케줄러/8_Composer 권한 및 인증]] — 3-layer 인증 모델
- [[10-스케줄러/9_Airflow Asset과 Dataset]] — Asset 개념 상세
- [[10-스케줄러/11_DAG Bundles와 배포 전략]] — DAG 배포 전략
- [[10-스케줄러/14_Composer 3 비용 구조]] — DCU 요금 모델
