...
> 관련: [[scheduler/6_Airflow 2 vs 3 비교]], [[scheduler/1_개요]], [[athlon/8_배포 시 유의할 점]]
...
관련: [[scheduler/2_Cloud Composer vs Self-managed 비교]], [[scheduler/0_결론]]
...
- 관련: [[scheduler/8_Composer 권한 및 인증]]
...
- 관련: [[scheduler/7_3_공통 Custom Operator 제공 방안]]
...
- 실측 예 ([[scheduler/7_2_리소스 다이어트 포인트]]): sensor 하나가 **월 522 worker-hours**
...
- 관련: [[scheduler/3_Executor 종류 및 비교]]
...
- 관련: [[athlon/8_배포 시 유의할 점]] § 2

### 2-6. 인증 · 권한

**3-layer 모델** (관련: [[scheduler/8_Composer 권한 및 인증]]):
...
- 관련: [[scheduler/14_Composer 3 비용 구조]], [[4_Composer_조사_요약]] § 4
...
- [[scheduler/6_Airflow 2 vs 3 비교]] — Airflow 버전 breaking change 상세
- [[scheduler/1_개요]] — Composer 3 운영 방향
- [[scheduler/2_Cloud Composer vs Self-managed 비교]] — Composer 채택 근거
- [[scheduler/8_Composer 권한 및 인증]] — 3-layer 인증 모델
- [[scheduler/9_Airflow Asset과 Dataset]] — Asset 개념 상세
- [[scheduler/11_DAG Bundles와 배포 전략]] — DAG 배포 전략
- [[scheduler/14_Composer 3 비용 구조]] — DCU 요금 모델
- [[athlon/8_배포 시 유의할 점]] — 실전 배포 함정
