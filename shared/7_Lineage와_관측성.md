...
> 관련: [[scheduler/9_Airflow Asset과 Dataset]], [[scheduler/10_DataHub vs Knowledge Catalog 비교]], [[athlon/4_Asset-Centric 아키텍처 안]]
...
- **로컬에서 수동 emit** — 데이터플랫폼팀 담당 (관련: [[athlon/8_배포 시 유의할 점]] § 4)
...
상세: [[scheduler/10_DataHub vs Knowledge Catalog 비교]]
...
- [[scheduler/10_DataHub vs Knowledge Catalog 비교]] — 툴 선정 근거
- [[athlon/4_Asset-Centric 아키텍처 안]] — Asset 중심 아키텍처 설계
- [[athlon/8_배포 시 유의할 점]] § 4-5 — DataHub CI 제약 실전
