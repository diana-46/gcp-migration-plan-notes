...
[[platform/athlon/PoC/03_bq_dbt_run_in_composer]] 의 분석에서 확인된 사내 검증 패턴:
...
### Layer 2 — dbt Project ([[platform/athlon/PoC/02_dbt_render_in_composer]], [[platform/athlon/PoC/03_bq_dbt_run_in_composer]])
