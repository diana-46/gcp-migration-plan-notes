...
> 관련: [[athlon/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]], [[dbt/0_dbt 기본 개념]]
...
**관련 노트**: [[athlon/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]], [[athlon/8_배포 시 유의할 점]], [[dbt/8_insert_overwrite_매커니즘]]
...
- [[athlon/5_Neptune SQL 변환의 dbt-BigQuery 대체 검토]] — 기술 검증 결과
